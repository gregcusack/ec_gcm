...
int main(int argc, char* argv[]){
    ...
    std::vector<std::string>    agent_ips{"10.0.2.15"};//"128.105.144.137"};//), "127.0.0.1", "127.0.0.1"};
    std::vector<uint16_t>       server_ports{4444}; //4444

    auto *gcm = new ec::GlobalCloudManager("10.0.2.15"/*"128.105.144.138"*/, GCM_PORT, agent_ips, server_ports);
