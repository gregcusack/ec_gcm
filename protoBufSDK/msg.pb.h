...
// optional uint64 quota = 7;
inline bool ECMessage::_internal_has_quota() const {
  bool value = (_has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool ECMessage::has_quota() const {
  return _internal_has_quota();
}
inline void ECMessage::clear_quota() {
  quota_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000040u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ECMessage::_internal_quota() const {
  return quota_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ECMessage::quota() const {
  // @@protoc_insertion_point(field_get:msg_struct.ECMessage.quota)
  return _internal_quota();
}
inline void ECMessage::_internal_set_quota(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000040u;
  quota_ = value;
}
inline void ECMessage::set_quota(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_quota(value);
  // @@protoc_insertion_point(field_set:msg_struct.ECMessage.quota)
}
