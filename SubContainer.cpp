...
ec::SubContainer::SubContainer(uint32_t cgroup_id, ip4_addr ip, uint32_t manager_id) {
...
ec::SubContainer::SubContainer(uint32_t cgroup_id, ip4_addr ip, uint32_t manager_id, uint64_t mem_lim)
    : mem_limit(mem_lim) {
